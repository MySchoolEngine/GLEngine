...
template <> struct DULib::enable_BitField_operators<GLEngine::Core::E_EventCategory> {
	static constexpr bool enable = true;
};

template <> struct DULib::BitField_UsedBitsCounter<GLEngine::Core::E_EventCategory> {
	static constexpr std::size_t usedBits = 8;
};
...
#define EVENT_CLASS_CATEGORY(category)                                                                                                                                             \
	virtual DULib::BitField<E_EventCategory> GetCategories() const override { return category; }
...
public:
	...
	virtual DULib::BitField<E_EventCategory> GetCategories() const = 0;
