...
namespace GLW {
	...
	{
		return const_cast<C_ShaderProgram *>(this)->glGetUniformBlockIndex(m_Program, name.c_str());
	}
	...
	{
		return const_cast<C_ShaderProgram *>(this)->glGetUniformBlockIndex(m_Program, name);
	}
}