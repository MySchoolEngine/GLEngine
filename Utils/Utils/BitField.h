...
public:
  ...
  constexpr C_BitField(const C_BitField &other) : m_Flags(other.m_Flags) {}
...
typename std::enable_if<Utils::enable_BitField_operators<Enum>::enable,
                        Utils::C_BitField<Enum>>::type
