...
//=================================================================================
C_Filter::C_Filter(C_Filter *innerFilter) : m_InnerFilter(innerFilter) {}
...
// C_ContextFilter
//=================================================================================
C_ContextFilter::C_ContextFilter(E_Context context,
                                 C_Filter *innerFilter /*= nullptr*/)
    : C_Filter(innerFilter), m_Context(context) {}
...
C_LevelFilter::C_LevelFilter(E_Level Level, C_Filter *innerFilter /*= nullptr*/)
    : C_Filter(innerFilter), m_Level(Level) {}
...
// C_PassAllFilter
//=================================================================================
C_TextFilter::C_TextFilter(const std::string &text,
                           C_Filter *innerFilter /*= nullptr*/)
    : C_Filter(innerFilter), m_Text(text) {}
...
// C_PassAllFilter
//=================================================================================
bool C_PassAllFilter::FilterCheck(const S_Data &message) { return false; }

//=================================================================================
// C_NegationFilter
//=================================================================================
C_NegationFilter::C_NegationFilter(C_Filter *negatedFilter, C_Filter *inner)
    : C_Filter(inner), m_NegatedFilter(negatedFilter) {}
