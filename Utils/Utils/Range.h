...
private:
        ...
        public:
                ...
                {
                        static_assert(is_iterator_of_v<iterBase, T>, "The
T_exterIter has to be of same type with T"); m_value.reset(new
Model<T_exterIter>(std::forward<T_exterIter>(value))); return *this;
                }
...
"Model(U&& val)");
        ...
        static_assert(is_iterator_of_v<iterBase, T>, "The iterable has to be of
same type with T"); public:
        ...
        C_Range(iterable&& begin, iterable&& end)
                ...
                , m_End(std::move(end))
        {
                static_assert(is_iterator_of_v<iterable, T>, "The iterable has
to be of same type with T");
        }
...
template <class T> struct Range {
  ...
  Range(Range &&other) : m_begin(other.m_begin), m_end(other.m_end) {}
