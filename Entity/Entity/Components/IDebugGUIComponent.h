...
public:
	I_DebugGUIComponent(std::shared_ptr<I_Entity> owner)
		: I_Component(owner){};
	virtual ~I_DebugGUIComponent() = default;
	virtual E_ComponentType GetType() const override { return E_ComponentType::DebugGUI; }

	virtual Physics::Primitives::S_AABB GetAABB() const override { return Physics::Primitives::S_AABB(); }
