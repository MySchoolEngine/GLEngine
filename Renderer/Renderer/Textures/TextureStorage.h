...
public:
  ...
  GetChannelOffset(E_TextureChannel element) const = 0;
...
public:
  ...
  // todo allow swizzle
  [[nodiscard]] virtual std::uint8_t
  GetChannelOffset(E_TextureChannel element) const override;
...
//=================================================================================
// template<class internalFormat, int elements, std::size_t width, std::size_t
// height> class C_TextureViewStorageCPUConst : I_TextureViewStorage
//{
// public:
