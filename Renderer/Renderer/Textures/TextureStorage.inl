...
C_TextureViewStorageCPU<internalFormat>::C_TextureViewStorageCPU(
    std::size_t width, std::size_t height, std::uint8_t elements)
    : I_TextureViewStorage(width, height), m_Elements(elements) {
...
//=================================================================================
template <class internalFormat>
float C_TextureViewStorageCPU<internalFormat>::GetF(
...
C_TextureViewStorageCPU<internalFormat>::GetNumElements() const {
  return m_Elements;
}
...
template <class internalFormat>
const void
C_TextureViewStorageCPU<internalFormat>::SetData(const void *data,
                                                 std::size_t pixels) {
...
//=================================================================================
template <class internalFormat>
std::uint8_t C_TextureViewStorageCPU<internalFormat>::GetChannelOffset(
...
//=================================================================================
template <class internalFormat>
void C_TextureViewStorageCPU<internalFormat>::SetInternal(
    int value, std::size_t position) {
...
template <class internalFormat>
void C_TextureViewStorageCPU<internalFormat>::SetInternal(
    double value, std::size_t position) {
  m_Data[position] = static_cast<internalFormat>(value);
}
...
E_TextureTypes C_TextureViewStorageCPU<internalFormat>::GetStorageType() const {
  ...
  static_assert(
      T_ContainsType_v<internalFormat, std::uint8_t, std::int8_t, float>,
      "Unsupported internal type of texture storage.");
}
