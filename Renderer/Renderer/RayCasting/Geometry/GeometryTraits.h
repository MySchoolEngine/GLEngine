...
public:
	...
	static float GetArea(const Physics::Primitives::S_Rectangle& rect);
	...
	static glm::vec3 GetNormal(const Physics::Primitives::S_Rectangle& rect);

	static glm::vec3 SamplePoint(const Physics::Primitives::S_Disc& disc, I_Sampler& rnd);
	static glm::vec3 SamplePoint(const Physics::Primitives::S_Rectangle& rect, I_Sampler& rnd);
	...
	static void FillIntersection(const Physics::Primitives::S_Rectangle& rect, float t, const Physics::Primitives::S_Ray& ray, C_RayIntersection& intersection);
