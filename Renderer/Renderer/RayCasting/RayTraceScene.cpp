...
//=================================================================================
C_RayIntersection::C_RayIntersection(S_Frame &&frame, glm::vec3 &&point,
                                     Physics::Primitives::S_Ray &&ray)
    : m_Frame(frame), m_Point(point), m_Ray(ray) {}

//=================================================================================
C_RayTraceScene::C_RayTraceScene() {
  using namespace Physics::Primitives;
  auto plane =
      std::make_unique<C_Primitive<S_Plane>>(S_Plane(glm::vec3(0, 1, 0), 0.0f));
  static const MeshData::Material mat1{glm::vec4{}, glm::vec4{255, 0, 255, 0},
                                       glm::vec4{}, 1.f, 0};
  static const MeshData::Material mat2{glm::vec4{}, glm::vec4{0, 0, 255, 0},
                                       glm::vec4{}, 1.f, 0};
  ...
  auto disc =
      std::make_unique<C_Primitive<S_Disc>>(S_Disc{normal2, -normal2, 0.5f});
...
//=================================================================================
bool C_RayTraceScene::Intersect(const Physics::Primitives::S_Ray &ray,
  ...
  std::for_each(m_Objects.begin(), m_Objects.end(),
                [&](const std::unique_ptr<I_RayGeometryObject> &object) {
  ...
  std::sort(intersections.begin(), intersections.end(),
            [](std::pair<C_RayIntersection, float> &a,
               std::pair<C_RayIntersection, float> &b) {
