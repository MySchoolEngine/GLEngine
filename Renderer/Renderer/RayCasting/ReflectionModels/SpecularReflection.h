...
public:
	...
	[[nodiscard]] virtual glm::vec3 f(const glm::vec3& wi, const glm::vec3& wo) const override;
	[[nodiscard]] virtual glm::vec3 SampleF(const glm::vec3& wi, glm::vec3& wo, const S_Frame& frame, const glm::vec2& rng, float* pdf) const override;
