...
FreelookCamera::FreelookCamera(std::shared_ptr<Entity::I_Entity> &owner)
    : I_CameraComponent(owner), _cameraMovementSpeed(1), m_Flags(), _yaw(0),
      _pitch(0), _timer(), _position(glm::vec3(0)), _up(glm::vec3(0, 1, 0)),
      _left(glm::vec3(1, 0, 0)), _view(glm::vec3(0, 0, 1)), m_rotation(),
      m_nearZ(0.1f), m_farZ(100.f), m_fov(90.f), m_aspectRatio(1900.f / 1080.f),
...
//=================================================================================
void FreelookCamera::setupCameraProjection(float nearZ, float farZ,
                                           float aspectRatio, float fovYDeg) {
  m_farZ = farZ;
  m_nearZ = nearZ;
  m_fov = fovYDeg;
...
//=================================================================================
void FreelookCamera::resetButtons() { m_Flags = 0; }

//=================================================================================
void FreelookCamera::positionCamera(const glm::vec3 &camPosition,
...
//=================================================================================
glm::mat4 FreelookCamera::GetViewMatrix() const { return _viewMatrix; }
...
//=================================================================================
float FreelookCamera::getMovementSpeed() const { return _cameraMovementSpeed; }

//=================================================================================
float FreelookCamera::GetFar() const { return m_farZ; }

//=================================================================================
float FreelookCamera::GetNear() const { return m_nearZ; }

//=================================================================================
float FreelookCamera::GetFov() const { return m_fov; }

//=================================================================================
float FreelookCamera::GetAspectRatio() const { return m_aspectRatio; }
...
//=================================================================================
bool FreelookCamera::HasDebugDrawGUI() const { return true; }

//=================================================================================
Physics::Primitives::S_AABB FreelookCamera::GetAABB() const {
  Physics::Primitives::C_Frustum frust(_position, _up, _view, m_nearZ, m_farZ,
                                       GetAspectRatio(), GetFov());
  return frust.GetAABB();
}

//=================================================================================
Physics::Primitives::C_Frustum FreelookCamera::GetFrustum() const {
  return Physics::Primitives::C_Frustum(_position, _up, _view, m_nearZ, m_farZ,
                                        m_aspectRatio, m_fov);
}
...
void FreelookCamera::CreateProjection() {
  _projectionMatrix =
      glm::perspective(glm::radians(m_fov), m_aspectRatio, m_nearZ, m_farZ);
  _ScreenToWorld = glm::inverse(_projectionMatrix * _viewMatrix);
}
...
//=================================================================================
glm::vec3 FreelookCamera::GetDirection() const { return _view; }

//=================================================================================
void FreelookCamera::OnEvent(Core::I_Event &event) {
  Core::C_EventDispatcher d(event);
  d.Dispatch<Core::C_KeyPressedEvent>(
      std::bind(&FreelookCamera::OnKeyPressed, this, std::placeholders::_1));
  d.Dispatch<Core::C_KeyReleasedEvent>(
      std::bind(&FreelookCamera::OnKeyReleased, this, std::placeholders::_1));
}
