...
//=================================================================================
S_Joint::S_Joint(std::size_t index, const std::string &name,
                 glm::mat4 localBindTransform)
    : m_Id(index), m_Name(name), m_InverseBindTransfomr(localBindTransform) {}

//=================================================================================
S_Joint::S_Joint(const S_Joint &other)
    : m_Name(other.m_Name),
      m_InverseBindTransfomr(other.m_InverseBindTransfomr), m_Id(other.m_Id),
...
S_Joint::S_Joint(S_Joint &&other)
    : m_Name(std::move(other.m_Name)),
      ...
      m_Id(other.m_Id), m_Children(std::move(other.m_Children)) {
...
//=================================================================================
void S_Joint::ApplyPoseToJoints(std::vector<glm::mat4> &poseData,
