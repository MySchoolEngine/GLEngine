...
public:
  ...
  GetModelSpaceTransform(int boneID) const override;
  virtual void SetModelSpaceTransform(const glm::mat4 &transform,
                                      int boneID) override;
  [[nodiscard]] virtual std::vector<glm::mat4>
  GetModelSpaceTransofrms() const override;
