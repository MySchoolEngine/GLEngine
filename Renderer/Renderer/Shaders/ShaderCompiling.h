...
//=================================================================================
template<class StageHandle>
const std::filesystem::path C_ShaderLoader<StageHandle>::s_ShadersFolder = "shaders/";
...
//=================================================================================
template<class StageHandle>
void ShaderCompilerTrait<StageHandle>::Reset()
{
...
//=================================================================================
template<class StageHandle>
typename ShaderCompilerTrait<StageHandle>::T_Paths ShaderCompilerTrait<StageHandle>::GetTouchedFiles() const
{
...
//=================================================================================
template<class StageHandle>
bool ShaderCompilerTrait<StageHandle>::_loadFile(const std::filesystem::path& file, std::string& content)
{
