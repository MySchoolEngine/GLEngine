...
//=================================================================================
C_D3D12Renderer::~C_D3D12Renderer() { delete m_CommandQueue; }

//=================================================================================
void C_D3D12Renderer::Lock(bool lock /*= true*/) { m_Locked = lock; }
...
//=================================================================================
void C_D3D12Renderer::ClearCommandBuffers() { m_CommandQueue->clear(); }
