...
//=================================================================================
template<E_FramebufferTarget framebuffer>
std::shared_ptr<GLEngine::Renderer::I_Resource> C_GLCheckFramebufferStatus<framebuffer>::GetResource() const
{
	return nullptr;
}
...
//=================================================================================
template<E_FramebufferTarget framebuffer>
Renderer::I_RenderCommand::E_Type C_GLCheckFramebufferStatus<framebuffer>::GetType() const
{
...
//=================================================================================
template<E_FramebufferTarget framebuffer>
void C_GLCheckFramebufferStatus<framebuffer>::Commit()
{
