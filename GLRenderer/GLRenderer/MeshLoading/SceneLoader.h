...
private:
	...
	void LoadJointsInvMatrices(const std::vector<std::string>& jointNames, std::vector<Renderer::Animation::S_Joint>& joints, const pugi::xml_node& skinXML, const glm::mat4& normalizinMatrix) const;
