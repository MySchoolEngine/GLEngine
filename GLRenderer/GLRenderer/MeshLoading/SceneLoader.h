...
public:
	...
	//filepath - the folder where the model is
	//filename - the actual name of the file
	bool addModelFromDAEFileToScene(const char* filepath, const char* filename, std::shared_ptr<C_StaticMeshResource>& mesh, std::string& textureName, Renderer::Animation::C_Skeleton& skeleton,
